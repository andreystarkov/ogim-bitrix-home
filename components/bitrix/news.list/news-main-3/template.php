...
$('ul.reset li').css({'background-image': 'none', 'margin-left': '0px', 'margin-top': '0px'});
...
<div class="news-list-item" onclick="window.location='http://www.ogim.ru<?=$arItem["DETAIL_PAGE_URL"];?>'">
